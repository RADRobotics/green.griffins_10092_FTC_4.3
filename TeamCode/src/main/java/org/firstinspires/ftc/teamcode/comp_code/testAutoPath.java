...
//    double scale = (640)/2;//-alignSize
    ...
    String csvData = "leftTargetPos,leftCurrentPos,P,I,D,F,G\r\n";

    public void runOpMode() throws InterruptedException {
        String readfile = "data.csv";
        ...
        while (opModeIsActive()) {
           ...
           // telemetry.addLine()
            ...
            if (step == -1) {
                ...
                csvData += setL + ","+hwmap.lw1.getCurrentPosition()+ "," + errorL*Kp + ","+Ki*sumErrorL +"," + Kd*dErrorL + "," + Kf*speedL + "," + gyroError*Kg +"\r\n";
